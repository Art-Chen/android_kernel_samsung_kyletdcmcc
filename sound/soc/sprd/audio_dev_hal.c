...
//  Note:
/*****************************************************************************/
PUBLIC void AUDDEV_SetPGA (uint32_t uiGain)
{
    uint32_t dac_pga = 0;
    uint32_t hp_pga  = 0;
...
//     printk ("1AUDDEV_SetPGA hp_pga=0x%x \n",hp_pga);

    pga.dac_pga_l = dac_pga;
//	printk ("2AUDDEV_SetPGA hp_pga=0x%x \n",hp_pga);
    pga.hp_pga_l = hp_pga;
//	printk ("3AUDDEV_SetPGA hp_pga_l=0x%x \n",pga.hp_pga_l);
    pga.dac_pga_r = dac_pga;	
    pga.hp_pga_r = hp_pga;
//	printk ("4AUDDEV_SetPGA hp_pga_r=0x%x \n",pga.hp_pga_r);

    CODEC_PHY_SetDACPGA (pga);
}
