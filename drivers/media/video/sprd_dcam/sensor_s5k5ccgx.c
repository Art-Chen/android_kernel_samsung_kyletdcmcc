...
LOCAL uint32_t s5k5ccgx_I2C_write(SENSOR_REG_T* sensor_reg_ptr)
{
	uint16_t 	i; 
       ...
       {
	     msleep(sensor_reg_ptr[i].reg_value);
       }
...
I2C_RETRY:
    ...
    for (i = 0; i < init_table_size; i++) 
    {
        ...
        {
            printk("s5k5ccgx_sensor_burst_write_buffer_overflow!!!\n");
            return err;
        }
        ...
        switch(subaddr)
        {
			...
			else
			{
                ...
                printk("s5k5ccgx_sensor_burst_write, delay %dms\n",value);
            break;
    ...
    printk("SENSOR: _s5k5ccgx_InitExt, success \n");
